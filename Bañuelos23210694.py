...
print (f"Función de tranferencia del controlador PID: {PID}")
...
fg1 = plt.figure()  #Respuesta escalón 
plt.plot(t,u1,'-',color = clr0,label='Pao(t)') #Entrada
plt.plot(t,PAu1,'--',color = clr3,label='PA(t)') #Respuesta en lazo abierto
plt.plot(t,PIDu1,'--',color = clr4,label='PID(t)') #Respuesta en lazo abierto
plt.xlim(0,10); plt.xticks (np.arange (0,11,1))
plt.ylim(0,1.); plt.yticks (np.arange (0,1.2,0.1))
...
plt.plot(t,PIDu2,'--',color = clr4,label='PID(t)') #Respuesta en lazo abierto
plt.xlim(0,10); plt.xticks (np.arange (0,11,1))
plt.ylim(0,1.); plt.yticks (np.arange (0,1.2,0.1))
plt.xlabel('t[s]', fontsize=11)
plt.ylabel('Vi(t) [V]',fontsize=11)
...
plt.plot(t,PIDu3,'--',color = clr4,label='PID(t)') #Respuesta en lazo abierto
plt.xlim(0,10); plt.xticks (np.arange (0,11,1))
plt.ylim(0,1.); plt.yticks (np.arange (0,1.2,0.1))
plt.xlabel('t[s]', fontsize=11)
plt.ylabel('Vi(t) [V]',fontsize=11)
...
plt.plot(t,PIDu4,'--',color = clr4,label='PID(t)') #Respuesta en lazo abierto
plt.xlim(0,10); plt.xticks (np.arange (0,11,1))
